{
  inputs =
    let
      version = "1.8.2";
system = "x86_64-linux";
devenv_root = "/home/nicolas/Documents/repos/Project-Emerge/UWB-anchor-firmware";
devenv_dotfile = "/home/nicolas/Documents/repos/Project-Emerge/UWB-anchor-firmware/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-0eb87e7";
