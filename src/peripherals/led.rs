...
pub trait IndicatorLed {
    type Error;
    fn show_battery_percentage(&mut self, percentage: u8) -> Result<(),IndicatorLedError<Self::Error>>;
}
...
impl <GreenPin: OutputPin, OrangePin: OutputPin> IndicatorLed for LtstIndicatorLed<GreenPin, OrangePin>
where
